...
<html>
 ...
 %>
		<div id="container">
															...
															<td>
																<select name="Service" id="Service"
																	...
																	<%
																		...
																		String name=session.getAttribute(ip+"EmpName").toString().trim();
																		String sql="";
																		
																		if("ZhouYuan".equals(name))
																		{
																		   sql="select ServiceNr from tb_SerOfSec where Section=? or Section=? or Section=?";
																		   String []paras={"000 General","EPD4","EPD5"};
																		...
																		sql = "select ServiceNr from tb_SerOfSec where Section=? or Section=? ";
			...
			<div style="margin:28% 0 0 0px"><jsp:include page="footer.jsp"></jsp:include></div>	
		</div>
		<!-- end container -->
	</body>
</html>