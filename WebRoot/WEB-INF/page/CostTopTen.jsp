...
<html>
	...
	<script type="text/javascript">
	   ...
	   function show()
	   {
		...
		{
		   document.form1.action =contextPath+"/AllChartAction!createCostTopTen";
           document.form1.submit();
		}      
	   }
	   function ChangeCostTopTen(val)
	   {
	      window.location.href="TopTenAction!CostTopTen?year="+val;  
	   }
	</script>
													...
													<tr style="height: 5px">
														<td align="left">
															...
															<%
																...
																int selectYear = 0;
																if (session.getAttribute(ip + "costtenYear") != null) {
																	selectYear = Integer.parseInt(session.getAttribute(
																			ip + "costtenYear").toString().trim());
																}
																out
																		.println("<select name='year' id='year' onChange='ChangeCostTopTen(this.value)'>");
																for (int k = 1; k <= 5; k++) {
