...
<html>
	...
	<script type="text/javascript">
	   var contextPath="<%=request.getContextPath()%>";
	    function showpart()
	    {
	       ...
	       if(v=='e.g. Name,TPM,OEM,Tier1,Status,Catagory') 
	       {
	...
	function checksearch(){
	 if(document.getElementById("search").value=='e.g. Name,TPM,OEM,Tier1,Status,Catagory')
     {
    ...
    function blursearch()
    {
     ...
     {
         document.getElementById("search").value='e.g. Name,TPM,OEM,Tier1,Status,Catagory';
										...
										<div id="comtable">
											...
											<form action="" method="post" name="form1" id="form1">
												<input onblur="blursearch()"
													...
													value="e.g. Name,TPM,OEM,Tier1,Status,Catagory"
														...
														<table border="1" bordercolor=green cellspacing=0
															...
															<s:iterator value="#request.pro" var="s" status="stuts">
																<tr
																	...
																	<td align="center">
																		<a href="ShowBudgetAction?proName=<s:property value="#s.proName" />">
																			<s:property value="#s.ebudget"/>
																		</a>
																	</td>
																	<td align="center">
											...
											<%
												if (request.getAttribute("pageNow") != null
													...
													int pageCount = Integer.parseInt(request.getAttribute(
															"pagecount").toString());
													out
															.println("<a href='showProjectAction!showAll?pageNow=1'>first</a>&nbsp;&nbsp;");
													if (pageNow > 1) {
														out.println("<a href='showProjectAction!showAll?pageNow="
																+ (pageNow - 1) + "'>front</a>&nbsp;&nbsp;");
													}
