...
<html>
	...
	<script type="text/javascript">
	   ...
	   function show()
	   {
		...
		{
		   document.form1.action =contextPath+"/AllChartAction!createBaseTopTen";
           document.form1.submit();
		}      
	   }
	   
	   function ChangeBaseTopTen(val)
	   {
	      window.location.href="TopTenAction!BaseTopTen?year="+val;  
	   }
	</script>
													...
													<tr style="height: 5px">
														<td align="left">
															...
															<%
																...
																int selectYear = 0;
																if (session.getAttribute(ip + "basetenYear") != null) {
																	selectYear = Integer.parseInt(session.getAttribute(
																			ip + "basetenYear").toString().trim());
																}
																out
																		.println("<select name='year' id='year' onChange='ChangeBaseTopTen(this.value)'>");
																for (int k = 1; k <= 5; k++) {
